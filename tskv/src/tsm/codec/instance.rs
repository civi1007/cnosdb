...
impl TimestampCodec for NullTimestampCodec {
    ...
    fn decode(
        ...
        ts_without_compress_decode(src, bit_set)
    }
}
...
impl TimestampCodec for DeltaTsTimestampCodec {
    ...
    fn decode(
        ...
        ts_zigzag_simple8b_decode(src, bit_set)
    }
}
...
impl IntegerCodec for NullIntegerCodec {
    ...
    fn decode(
        ...
        i64_without_compress_decode(src, bit_set)
    }
}
...
impl IntegerCodec for DeltaIntegerCodec {
    ...
    fn decode(
        ...
        i64_zigzag_simple8b_decode(src, null_buffer)
    }
}
...
impl StringCodec for NullStringCodec {
    ...
    fn decode(
        ...
        str_without_compress_decode(src, bit_set)
    }
}
